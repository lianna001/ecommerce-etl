...
Select the 3-5 most important ones from a business perspective and summarize each in one line.

{chr(10).join(f'- {h}' for h in headlines)}

Format:
- [Summarized headline] : One-line key takeaway
"""
    ...
    print(f"News summary complete ({len(headlines)} headlines from {yesterday})")
    return news